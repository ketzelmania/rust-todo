...
pub async fn get_user(env: Environment, args: requests::GetArgs) -> Result<impl Reply, Rejection> {
...
pub async fn post_user(env: Environment, args: User) -> Result<impl Reply, Rejection> {
